...
namespace MoviesApi
{
    public class ApplicationDbContext : DbContext
    {
        ...
        {
        //    OracleConfiguration.TnsAdmin = @"C:\app\User\product\21c\homes\OraDB21Home1\network\admin";
        //    OracleConfiguration.WalletLocation = @"C:\app\User\product\21c\admin\XE\xdb_wallet";
        }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MoviesActors>().HasKey(post => new { post.PersonId, post.MovieId });
